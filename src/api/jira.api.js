  ...
  getTaskTitle = () => {
    return new Promise((resolve, reject) => {
      ...
      chrome.tabs.executeScript(
        {
          code: `(document.querySelector("*[data-test-id='issue.views.issue-base.foundation.summary.heading']") || document.querySelector('[aria-label="Edit Summary"]').parentElement.children[0].innerText).innerText`
        },
        result => {
